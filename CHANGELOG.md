...
- **User-Priority:**
  ...
  - **[Review]** - The generic review workflow now classifies risk-only mandatory issue-class concerns as `OBSERVATIONS` unless the current run proves concrete blocking harm, and it hard-stops instead of emitting final review bodies that still contain editor-local file links.
