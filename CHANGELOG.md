...
- **User-Priority:**
  ...
  - **[Docs]** - Changed the shipped Playground plugin README so Agency users now get release-focused installation and review-agent usage guidance, while maintainer-only validation, staged export, and debug instructions moved into a separate repo-only CLI plugin contributor guide.
