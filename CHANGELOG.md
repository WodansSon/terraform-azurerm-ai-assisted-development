...
- **User-Priority:**
  ...
  - **[Review]** - Shared review guidance now centralizes more PR-scope and linter execution-state logic in the review contract while keeping the committed-review prompt thinner and less repetitive.
