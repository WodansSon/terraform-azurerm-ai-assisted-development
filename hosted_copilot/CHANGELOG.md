...
- Preserved every failed reconciliation attempt with its validation reason and changed duplicate-target final merges from fatal startup failures into schema-valid blocked Workbench displays that retain conflict evidence, keep unaffected candidates reviewable, present blocking state through an actionable error MessageBar, and disable approval until conflicts are resolved.
