...
- Added versioned source definitions, parser contracts, deterministic collection-only inventories, complete-corpus assessment and reconciliation, one self-contained Workbench bundle, and generation-wide publication with removed-source tombstones, exact prior-generation lineage, current-behavior validation, canonical UTC timestamps, compare-and-swap replacement, and atomic content-addressed history.
...
- Organized Hosted tooling around three root-level everyday commands, grouped specialized catalog and review commands, dedicated internal, module, test, migration, and legacy directories, and permanent layout enforcement.
