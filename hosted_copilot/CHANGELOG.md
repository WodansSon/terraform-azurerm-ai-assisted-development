...
- Made interactive startup report semantic-assessment progress before staging and server readiness, persist and revalidate assessments per unchanged source record, evaluate only cache misses, expose configurable cache and retained-run recovery paths, clean temporary artifacts only after success, and preserve machine-readable automation output.
