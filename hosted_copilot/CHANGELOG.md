...
- Expanded the pinned, locally hosted Codicon inventory with folder-state, directory-link, workspace-trust, and remote-connection symbols for current and future Workbench surfaces.
