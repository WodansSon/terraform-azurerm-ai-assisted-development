...
- Improved Workbench usability across supported viewports with sticky candidate-tree ancestry, stable row and scrollbar alignment, accessible controls, hierarchical readiness cues, non-destructive candidate search, consistent clamped tooltips and tree truncation, unobtrusive VS Code-style scrollbars, reliable Bulk Actions, clearer status feedback, and consistent Candidate, Details, Assessment, Plan, and Preview workflows.
