...
- Organized Hosted tooling around four root-level everyday commands, grouped specialized catalog commands, dedicated internal, module, test, migration, and legacy directories, and permanent layout enforcement.
