...
$canonicalBuilderPath = [IO.Path]::GetFullPath((Join-Path $resolvedRepositoryRoot 'hosted_copilot/tools/New-HostedRuleChangeRecommendations.ps1'))
...
try {
    ...
    $snapshotBuilderPath = Join-Path $runRepositoryRoot 'hosted_copilot/tools/New-HostedRuleChangeRecommendations.ps1'
