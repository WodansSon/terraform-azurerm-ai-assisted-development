...
"@, [Text.UTF8Encoding]::new($false))
    ...
    $codiconContractValid = $codiconSourceCount -eq 58 -and ([regex]::Matches($generatedSpriteContent, '<symbol id="codicon-').Count -eq 60)
    ...
    $portableIconGenerationValid = $codiconGenerationExitCode -eq 0 -and $octiconGenerationExitCode -eq 0 -and
        [regex]::Matches($generatedCodiconSprite, '<symbol id="codicon-').Count -eq 60 -and
