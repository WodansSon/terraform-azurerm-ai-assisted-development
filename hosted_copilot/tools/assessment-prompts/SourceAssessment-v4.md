...
- Treat the protected rules catalog as immutable Hosted context. Report every material equivalent, partial-overlap, extending, narrowing, conflicting, or related relationship through `relatedHostedCoverage`; do not map source identity to a protected rule or recommend changing protected content.
