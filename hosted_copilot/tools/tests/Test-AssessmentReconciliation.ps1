...
$builderPath = Join-Path $PSScriptRoot '../internal/reconciliation/New-HostedRuleChangeRecommendations.ps1'
$runnerPath = Join-Path $PSScriptRoot '../internal/reconciliation/Invoke-AssessmentReconciliation.ps1'
$reviewBuilderPath = Join-Path $PSScriptRoot '../internal/reconciliation/New-AssessmentReconciliationReview.ps1'
$publisherPath = Join-Path $PSScriptRoot '../internal/publication/Publish-SourceGeneration.ps1'
...
'@ + "`n", [Text.UTF8Encoding]::new($false))
    ...
    $isolatedHelpersPath = Join-Path $isolatedRepositoryRoot 'hosted_copilot/tools/modules/shared/HostedToolkit.Helpers.psm1'
