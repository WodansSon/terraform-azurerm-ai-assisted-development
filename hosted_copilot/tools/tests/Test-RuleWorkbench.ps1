...
try {
    ...
    $codiconContractValid = $codiconContractValid -and $iconGeneratorContent -match '\.\./\.\./\.\./workbench/icons' -and $iconGeneratorContent -match 'Get-Content -LiteralPath \$sourcePath -Raw' -and $iconGeneratorContent -match "'fold-up'" -and $iconGeneratorContent -match "'diff-modified'" -and $iconGeneratorContent -match "'arrow-circle-up'" -and $iconGeneratorContent -match "'arrow-circle-up-sparkle'" -and $iconGeneratorContent -match "'remote'" -and $iconGeneratorContent -match "'remote-compact'" -and $iconGeneratorContent -notmatch 'Invoke-WebRequest|Invoke-RestMethod|https://raw'
    ...
    Add-TestResult -Name 'row-keyboard-navigation' -Passed $keyboardNavigationValid -Detail 'Arrow keys move candidate, assessment, and conflict selection in place; Enter or Space opens the full-width Details view without intercepting leaf checkboxes or collapsed folders.'
    ...
    $assessmentResultsValid = $tabStateValid -and
        $indexContent -match 'data-workspace-tab="conflicts"' -and
        $indexContent -match 'id="conflict-list"' -and
        $indexContent -match 'id="conflict-detail"' -and
