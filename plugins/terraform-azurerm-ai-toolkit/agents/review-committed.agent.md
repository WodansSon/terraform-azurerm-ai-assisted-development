...
```text
Cannot run review-committed: target repo is missing required AI toolkit instruction files for committed review. Install the AI toolkit into the target repo and re-run this agent.
```
